        ...
        <div className="container py-5">
            <div className="row mb-5">
                <div className="col-md-8 col-xl-6 text-center mx-auto">
                    ...
                    <p className="text-muted w-lg-50">How you can reach us.&nbsp;</p>
                </div>
            </div>
                    ...
                    <div className="d-flex flex-wrap flex-md-column justify-content-md-start align-items-md-start h-100">
                        <div className="d-flex align-items-center p-3">
                            ...
                            <div className="px-2">
                                ...
                                <p className="text-muted mb-0">(022) 20568888</p>
                            </div>
                        </div>
                        <div className="d-flex align-items-center p-3">
                            ...
                            <div className="px-2">
                                ...
                                <p className="text-muted mb-0">admin@panensampah.com</p>
                            </div>
                        </div>
                        <div className="d-flex align-items-center p-3">
                            ...
                            <div className="px-2">
                                ...
                                <p className="text-muted mb-0">Paskal Hyper Square, Jl. Pasir Kaliki No.25-27,
