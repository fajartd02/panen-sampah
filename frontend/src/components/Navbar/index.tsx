...
function Navbar(props: NavbarInterface) {
  ...
  return (
    <nav className="navbar navbar-light navbar-expand-lg fixed-top py-3">
    <div className="container">
        <Link to='/'><a className="navbar-brand logo js-scroll-trigger"><img src="assets/img/logo-full.png" style={{height: '47px'}} /></a></Link>
        <button className="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarTogglerDemo02" aria-controls="navbarTogglerDemo02" aria-expanded="false" aria-label="Toggle navigation">
            <span className="navbar-toggler-icon"></span>
          </button>
        <div id="navbarTogglerDemo02" className="collapse navbar-collapse">
            <ul className="navbar-nav ms-auto">
            <Link to="/" style={{textDecoration: 'none'}}><li className="nav-item"><a className="nav-link">Home</a></li> </Link>
            <Link to="/service" style={{textDecoration: 'none'}}><li className="nav-item"><a className="nav-link">Services</a></li> </Link>
            <Link to="/map" style={{textDecoration: 'none'}}><li className="nav-item"><a className="nav-link">Map</a></li> </Link>
            <Link to="/contact" style={{textDecoration: 'none'}}><li className="nav-item"><a className="nav-link">Contacts</a></li></Link>
                <ul className="navbar-nav flex-nowrap ms-auto">
                    ...
                    <li className="nav-item dropdown no-arrow">
                        <div className="nav-item dropdown no-arrow"><a className="dropdown-toggle nav-link" aria-expanded="false" data-bs-toggle="dropdown" href="#"><span className="d-none d-lg-inline me-2 small">{username}</span><img className="border rounded-circle img-profile" src="assets/img/default.jpg" width="32px" /></a>
                            <div className="dropdown-menu shadow dropdown-menu-end animated--grow-in">
                                <a className="dropdown-item" href="dashboard.html">
                                    <i className="fas fa-list fa-sm fa-fw me-2 text-gray-400"></i>&nbsp;Dashboard
                                </a>
                                <a className="dropdown-item" href="tunai.html">
                                    <i className="fas fa-dollar-sign fa-sm fa-fw me-2 text-gray-400"></i>&nbsp;Tukar tunai
                                </a>
                                <a className="dropdown-item" href="emas.html">
                                    <i className="fas fa-coins fa-sm fa-fw me-2 text-gray-400"></i>&nbsp;Tukar emas
                                </a>
                                <a className="dropdown-item" href="kirim.html">
                                    <i className="fas fa-truck fa-sm fa-fw me-2 text-gray-400"></i>&nbsp;Kirim sampah
                                </a>
                                <div className="dropdown-divider"></div><button className="dropdown-item" onClick={logout}><i className="fas fa-sign-out-alt fa-sm fa-fw me-2 text-gray-400"></i>&nbsp;Logout</button>
                            </div>
                        </div>
                    </li>
                </ul>
